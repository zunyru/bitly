            ...
            @else
                ...
                >
                    ...
                    @foreach($query as $relationshipData)
                        @if($relationshipField =='lab_result_belongsto_process_relationship')
                            @php
                                $order_repo = new App\Repositories\OrderRepository();
                                $order = $order_repo->findOrderByProcess($relationshipData->order_history_id);
                            @endphp
                            <option value="{{ $relationshipData->{$options->key} }}"
                                ...
                                {{ order_number($relationshipData->order_history_id) }}
                                @if(is_null($order->customer))
                                    {{ "!! ข้อมูลลูกค้านี้ถูกลบไปแล้ว !!" }}
                                @else
