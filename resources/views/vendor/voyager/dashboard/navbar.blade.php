    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <button class="hamburger btn-link">
                ...
                <img class="svg" src="{{ asset('assets/media/icons/svg/Navigation/Angle-double-left.svg') }}" />
                <img class="svg" src="{{ asset('assets/media/icons/svg/Navigation/Angle-double-right.svg') }}" />
            </button>
            @section('breadcrumbs')
            <ol class="breadcrumb hidden-xs">
                ...
                @else
                <li class="active">
                    <a href="{{ route('voyager.dashboard')}}"><i class="voyager-home"></i>
